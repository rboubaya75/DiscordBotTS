...
client.on('ready', () => {
  ...
  client.user.setActivity('Call of Duty', { type: 'PLAYING' });
});
client.on("ready", () => {
  console.log("ok");  
})
...
client.on('message', (message: Message) => {
  console.log('[${client.author.tag}]: ${message.content}');
  if ((message.content == "hello") || (message.content == "guten tag" )||(message.content == "bonjour" )|| (message.content =="salut")) { 
    message.reply("Bonjour, soyez les bienvenus au salon des geeks !");
  };
});
